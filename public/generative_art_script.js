$(function () {
    ...
    , "../public/animations/four_seasons_6_11_22.mp4", "../public/animations/quilt_6_23_22.mp4", "../public/animations/big_bang_6_24_22.mp4#t=1",
   "../public/animations/bouncing_ball_6_24_22.mp4#t=7"];
    ...
    for (let i = 0; i < videoPath.length; i++) {
      ...
      videoDiv.wrap("<div class='img-c'></div>");
        ...
        if(isMobile) {
          video.src = videoPath[i] + "#t=0.1";
        } else {
          if(!videoPath[i].includes("#t=")) {
            video.src = videoPath[i] + "#t=30";
          } else {
            video.src = videoPath[i];
          }
        }
