...
const posts = [
	...
	{ category: "se", title: "This Personal Website!", text: "A full stack personal website involving HTML, CSS, Javascript, and a NodeJS backend. Featuring personally created artwork, music from Spotify, links to my projects on GitHub, and a contact section which sends your message to my Telegram bot.", img: "../public/image/portfolio-website.png", link: "https://github.com/sirDevelop/portfolio-website", linkTitle: "Source Code" },
	{ category: "se", title: "ToDo List App", text: "Web application that allows users to login with Google OAuth, create todo lists and edit, save, and delete tasks. The overdue tasks are highlighted. The app is built with a React frontend, a NodeJS backend, and MongoDB.", img: "../public/image/todo-react-app.png", link: "https://github.com/sirDevelop/todoListReact", linkTitle: "Source Code" },
